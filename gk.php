...
<body>
	...
	<div id="testsidebar">
		...
		<a href="gk.php" style="background:green;" >Gernal Knowledge</a><br/><br/>
		<a href="english.php" >English</a>
	 </div>
	 		<a href="gktest.php" style=" position:relative; left:30%; top:50px;  " ><button style="width:200px; height:30px;  font-size:16px;" >Ready For Test
	 		</button></a>
	</div>
</body>
</html>
