...
<body>
	...
	<div id="testsidebar">
		...
		<a href="physicsinsert.php" style="background:green;" >Physics</a><br/><br/>
		<a href="chemistryinsert.php" >Chemistry</a><br/><br/>
		<a href="mathsinsert.php" >Maths</a><br/><br/>
...
<div>
<form action="physicsdata.php? id=<?php  $_SESSION['admin'] ?> && sub=physics" method="post" >
...
<td><textarea  name="subject" cols="35" rows="2" ></textarea></td>
</tr>
<tr>
