 ...
 <body>
  ...
  <div id="testsidebar">
   ...
   ?>
    ...
    <p>1/10</p>
    <p ><b>Question#1:</b></p><p><?php echo $question; ?></p>
    ...
    <center><input style="height:30px; width:170px; font-size:20px; background:lightblue; color:black;" type="submit" value=" Submit Answer" name="submit">
    </center>
   </form>
  </div>
     <?php
    ...
    if($page > 1)
    {
     echo "<a style=' padding:8px 16px; border:1px solid #ccc; color:#333; font-weight:bold; position:relative; bottom:500px;' href='pagination.php?page=1'>First</a>";
     echo "<a style=' padding:8px 16px; border:1px solid #ccc; color:#333; font-weight:bold; position:relative; bottom:500px;' href='pagination.php?page=".($page - 1)."'><<</a>";
    }
    for($i=$start_loop; $i<=$end_loop; $i++)
    {     
     echo "<a  style=' padding:8px 16px; border:1px solid #ccc; color:#333; font-weight:bold; position:relative; bottom:500px;' href='pagination.php?page=".$i."'>".$i."</a>";
    }
    if($page <= $end_loop)
    {
     echo "<a style=' padding:8px 16px; border:1px solid #ccc; color:#333; font-weight:bold; position:relative; bottom:500px;' href='pagination.php?page=".($page + 1)."'>>></a>";
     echo "<a style=' padding:8px 16px; border:1px solid #ccc; color:#333; font-weight:bold; position:relative; bottom:500px;' href='pagination.php?page=".$total_pages."'>Last</a>";
    }
