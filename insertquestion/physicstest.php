...
$query = "SELECT * FROM physics  order by id DESC LIMIT $start_from, $record_per_page";
 ...
 <body>
  ...
  <?php  } mysqli_close($con); ?>
    <div class="navbar"  >
      ...
      <a style="position:relative; right:260px;" href="">HOME</a>
      <a  style="position:relative; right:260px;" href="">HOME</a>
       <div id="status" style="width:100px; height:30px;  float:right; font-size:15px; position:relative; left:100px; top:5px; color:white; "><script>countdown(20,"status");</script></div>
  ...
  <div id="testsidebar">
    ...
    <a href="../physics.php" style="background:green;" >Physics</a><br/><br/>
   ...
   ?>
    ...
    font-size:20px;">
    <form action="../answerdata.php?ans=physicsanswer && subject=physics &&  quesno= <?php echo $rowno-($id-1); ?>  &&  idno= <?php echo $id; ?>" method="post" >
      <u>
    ...
    <div align="center">
    <?php
    $page_query = "SELECT * FROM physics ORDER BY id DESC";
    ...
    if($page > 1)
    {
     ...
     echo "<a style=' padding:8px 16px; border:1px solid #ccc; color:#333; font-weight:bold; position:relative; bottom:500px; background:navy; color:white;' href='physicstest.php?page=".($page-1)."'>Previous</a>";
    }
    for($i=$start_loop; $i<=$end_loop; $i++)
    {     
     echo "<a  style=' padding:8px 16px; border:1px solid #ccc; color:#333; font-weight:bold; position:relative; bottom:500px;' href='physicstest.php?page=".$i."'>".$i."</a>";
    }
    if($page < $end_loop)
    {
     echo "<a style=' padding:8px 16px; border:1px solid #ccc; color:#333; font-weight:bold; position:relative; bottom:500px; background:navy; color:white;' href='physicstest.php?page=".($page + 1)."'>Next</a>";
